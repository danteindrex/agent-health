...
const mcpClient = new Client({ name: "orchestrator-client", version: "1.0.0" }, { capabilities: {} });
await mcpClient.connect(transport);
const { tools: mcpTools } = await mcpClient.listTools();
import { tool } from "@langchain/core/tools";
// Map MCP tools to LangChain tools
const tools = mcpTools.map((t) => tool(async (args) => {
...
// 5. Test Function
export async function runClinicalTask(task, threadId = "patient-session-1") {
...
//# sourceMappingURL=agent_orchestrator.js.map