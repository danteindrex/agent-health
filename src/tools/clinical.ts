...
export async function observationPost(args: any) {
...
export async function insuranceCheck(args: any) {
...
export async function logAuditTrail(args: any) {
...
export async function clinicAnalytics(args: any) {
  const { date } = args;
  try {
